...
describe Listen::Adapters::Polling do
  describe "#poll" do
    ...
    it "calls listener.on_change" do
      ...
      listener.should_receive(:on_change).at_least(1).times.with([listener.directory], :recursive => true)
    ...
    it "calls listener.on_change continuously" do
      ...
      listener.should_receive(:on_change).at_least(10).times.with([listener.directory], :recursive => true)
      Thread.new { adapter.start }
      sleep 0.1
      adapter.stop
    end
